...
public class MarketAdapter extends RecyclerView.Adapter<MarketAdapter.CustomViewHolder> {

    private ArrayList<MarketData> mList = null;
    private Activity context = null;
    private View.OnClickListener onClickListener;

    public MarketAdapter(Activity context, ArrayList<MarketData> list, View.OnClickListener onClick) {
    ...
    public MarketData getMarket(int position){
