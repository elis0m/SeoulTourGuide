...
public class AssetAdapter extends RecyclerView.Adapter<AssetAdapter.CustomViewHolder> {

    private ArrayList<AssetData> mList = null;
    private Activity context = null;
    private View.OnClickListener onClickListener;

    public AssetAdapter(Activity context, ArrayList<AssetData> list, View.OnClickListener onClick) {
    ...
    public CustomViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_asset, null);
    ...
    public AssetData getAsset(int position){
