...
public class MuseumActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new UsersAdapter(this, mArrayList, new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(obj != null){
                    ...
                    Intent intent = new Intent(MuseumActivity.this , SpotActivity.class);
        ...
        task.execute( "http://101.101.166.184/getjson_museum.php", "");
    ...
    private class GetData extends AsyncTask<String, Void, String>{
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(MuseumActivity.this,
