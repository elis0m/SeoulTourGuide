...
public class MarketActivity extends AppCompatActivity {
    ...
    private ArrayList<MarketData> mArrayList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new MarketAdapter(this, mArrayList, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if(obj != null){
                    ...
                    ((MarketAdapter)mAdapter).getMarket(position).getCity();
                    Intent intent = new Intent(MarketActivity.this , MarketDetailActivity.class);
                    intent.putExtra("market", ((MarketAdapter)mAdapter).getMarket(position));
        ...
        task.execute( "http://101.101.166.184/getjson_market.php", "");
    ...
    private class GetData extends AsyncTask<String, Void, String> {
        ...
        protected void onPreExecute() {
            ...
            progressDialog = ProgressDialog.show(MarketActivity.this,
    ...
    private void showResult(){
        ...
        try {
            ...
            for(int i=0;i<jsonArray.length();i++){
                ...
                marketData.setCity(city);
                marketData.setGu(gu);
                marketData.setDong(dong);
                marketData.setSite(site);

                mArrayList.add(marketData);
                mAdapter.notifyDataSetChanged();
            }
